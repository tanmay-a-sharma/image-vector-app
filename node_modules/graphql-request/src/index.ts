import createRequestBody from 'graphql-request/src/createRequestBody.js'
import { defaultJsonSerializer } from 'graphql-request/src/defaultJsonSerializer.js'
import { HeadersInstanceToPlainObject, uppercase } from 'graphql-request/src/helpers.js'
import {
...
} from 'graphql-request/src/parseArgs.js'
import { resolveRequestDocument } from 'graphql-request/src/resolveRequestDocument.js'
import type * as Dom from 'graphql-request/src/types.dom.js'
import type {
  HTTPMethodInput,
  MaybeFunction,
  RequestConfig,
...
} from 'graphql-request/src/types.js'
import {
...
export { GraphQLWebSocketClient } from 'graphql-request/src/graphql-ws.js'
export { resolveRequestDocument } from 'graphql-request/src/resolveRequestDocument.js'
